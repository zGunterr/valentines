...
function iHeartYou(){
	...
	if(window.location.hash){
		...
		vtext.textContent = "a lovely message from me to gorgeous girl <3";
	}
...
var yourMessage = "loveyougorgeous"//document.getElementById("your_message");
var yourLink = "mnwdxntfnsfdntr"//document.getElementById("your_link");
function linkChangey(){
	if(yourMessage.value==""){
		yourLink.value = "http://ncase.me/door/";
	}else{
		yourLink.value = "http://ncase.me/door/#mnwdxntfnsfdntr"//+encodeURIComponent(encryptString(yourMessage.value));
	}
};
